...
#define STRING_CONFIG_H_AUTHOR "(borrillis, SKR 1.3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aurora AM"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 50, 400, 500 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 80
